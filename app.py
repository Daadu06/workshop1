...
retriever = internet_store.as_retriever(search_kwargs={"k": 2})
...
kt_rag_chain = (
    {
        "context": kt_retriever | format_docs,
        "question": RunnablePassthrough(),
    }
    | kt_rag_prompt
    | llm
...
internet_agent_runnable = RunnableLambda(
    lambda question: run_agent(internet_agent, question)
)

kt_agent_runnable = RunnableLambda(
    lambda question: run_agent(kt_agent, question)
)
